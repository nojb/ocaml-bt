...
(* OASIS_START *)
(* DO NOT EDIT (digest: 10427df45437ff4851ee769bbcc82269) *)
(*
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "BitTorrent client library";
          description = None;
          categories = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Bcode"; "Get"; "Put"; "Word160"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "bt";
                      lib_findlib_name = Some "common";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "dht";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "bt_common"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Krpc"; "Routing"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "bt";
                      lib_findlib_name = Some "dht";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "bt_dht"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "find_ih.ml"})
            ];
          plugins =
